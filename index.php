    ...
    if(empty($username_err) && empty($password_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                echo "Oops! มีบางอย่างผิดพลาด กรุณาลองอีกครั้งในภายหลัง";
            }
        }
...
<head>
    <meta charset="UTF-8">
    <title>Clinic Manager : Login</title>
...
<body>
  <center>
    <div class="jumbotron">
        <h2>เ ข้ า สู่ ร ะ บ บ</h2>
        <p>กรอกชื่อผู้ใช้ และ รหัสผ่านเพื่อนเข้าสู่ระบบ</p>
